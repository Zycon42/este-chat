...
export default {
  ...
  threads: {
    ...
    3: {id: 3, name: 'Brian', avatarUrl: 'https://www.gravatar.com/avatar/fa95f818614298b5a4e2e8706dc135a7?d=identicon',
      lastMessage: {
        id: 7, authorName: 'Zycon', text: 'At ForwardJS?  Yeah, of course.  See you there!', date: Date.now() - 39999
    }}
  },
  messages: {
    1: [
      {id: 1, authorName: 'Zycon', text: 'Hey Jing, want to give a Flux talk at ForwardJS?', date: Date.now() - 99999},
      {id: 2, authorName: 'Zycon', text: 'Seems like a pretty cool conference.', date: Date.now() - 89999},
      {id: 3, authorName: 'Jing', text: 'Sounds good.  Will they be serving dessert?', date: Date.now() - 79999}
    ],
    2: [
      {id: 4, authorName: 'Zycon', text: 'Hey Dave, want to get a beer after the conference?', date: Date.now() - 69999},
      {id: 5, authorName: 'Dave', text: 'Totally!  Meet you at the hotel bar.', date: Date.now() - 59999}
    ],
    3: [
      {id: 6, authorName: 'Brian', text: 'Hey Zycon, are you going to be talking about functional stuff?',
        date: Date.now() - 49999},
      {id: 7, authorName: 'Zycon', text: 'At ForwardJS?  Yeah, of course.  See you there!', date: Date.now() - 39999}
    ]
  },
